...
class StudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bulletin_file' => 'nullable|file|max:2048',
    ...
    public function messages(): array
    {
        return [
            ...
            'bulletin_file.file' => 'Le fichier bulletin doit être un fichier.',
            'bulletin_file.max' => 'Le fichier bulletin ne doit pas dépasser 2048 Ko.',
