...
<div class="p-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold tracking-tight">Ajouter un parent</h1>
        <p class="text-zinc-500">Remplissez les informations pour créer un nouveau parent d'élève.</p>
    </div>
    ...
    <div class="max-w-2xl rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
        <form action="{{ route('guardians.store') }}" method="POST" class="space-y-4">
            ...
            <div class="space-y-2">
                ...
                <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full rounded-md border border-zinc-200 bg-transparent px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:border-zinc-800" required>
