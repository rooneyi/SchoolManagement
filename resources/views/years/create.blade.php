...
<div class="p-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold tracking-tight">Ajouter une année scolaire</h1>
        <p class="text-zinc-500">Configurez une nouvelle période académique.</p>
    </div>
    ...
    <div class="max-w-2xl rounded-xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-950">
        <form action="{{ route('years.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" class="flex h-10 w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:border-zinc-800 dark:bg-zinc-950" required>
            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" class="flex h-10 w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:border-zinc-800 dark:bg-zinc-950" required>
                ...
                <div class="space-y-2">
                    ...
                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" class="flex h-10 w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:border-zinc-800 dark:bg-zinc-950" required>
